import java.util.*;
public class PensionControibutionaCalculator {
	public static void main(String[] args) {
		...
		final double EMPLOYEE_RATE_55_TO_65 = 0.075;
		final double EMPLOYER_RATE_55_TO_65 = 0.09;
		...
		if (age <= 55) {
			...
			employeeContribution = contributableSalary*EMPLOYEE_RATE_55_TO_65;
			employerContribution = contributableSalary*EMPLOYER_RATE_55_TO_65;
		}
		else {
